...
例如，您可以添加个性化表达式作为`Hello {{lead.firstName}} {{lead.lastName}}`。 处理内容时，Journey Optimizer B2B Edition会使用Experience Platform数据库中包含的数据替换表达式。 因此，第一个示例变为&#x200B;_Hello John Doe_。
...
以下示例概述了使用人员和系统令牌使内容个性化的步骤。 它反映了当前的Journey Optimizer B2B Edition版本。
