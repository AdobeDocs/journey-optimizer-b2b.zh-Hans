...
1. 要开始内容设计，请从&#x200B;**[!UICONTROL 结构]**&#x200B;中拖动一个项，然后将其放到画布上。
   ...
   有关使用和格式化这些组件的详细信息，请参阅&#x200B;_[结构组件](../user/content/structure-components.md)_。
...
1. 展开&#x200B;**[!UICONTROL 内容]**&#x200B;部分，然后根据需要将任意数量的内容组件添加到一个或多个结构组件中。
   ...
   * [按钮](../user/content/content-components.md#button)
   * [文本](../user/content/content-components.md#text)
   * [分隔条](../user/content/content-components.md#divider)
   * [图像](../user/content/content-components.md#image)
   * [社交](../user/content/content-components.md#social)
   * [表单](../user/content/content-components.md#form)（仅登陆页面）
