...
查看Journey Optimizer B2B Prime管理员和营销人员入门指南。

[管理员](./start/setup-prime.md)
[用户](./start/get-started.md)
:::
...
[探索历程](./marketing/person-journeys.md)
:::
...
构建和维护根据用户档案属性和行为自动更新的人员列表。

[了解动态受众](./audiences/dynamic-audience-qualification.md)
:::
