---
title: 销售限定词
description: Journey Optimizer B2B Prime的销售鉴定表为BDR提供AI潜在客户鉴别、出站工作流、CRM集成、任务和配置文件设置。
...
Sales Qualifier是可以与[!DNL Adobe Journey Optimizer B2B Prime]一起使用的AI驱动应用程序。 它实施了Account Qualification Agent，旨在简化业务开发代表(BDR)的工作流。 Sales Qualifier跨渠道自动执行潜在客户鉴别、外联和买方参与工作流程。 它减少了手动BDR负载，加快了企业B2B公司的管道速度。
...
Sales Qualifier包含在[!DNL Journey Optimizer B2B Prime]中，但它是Adobe Experience Platform中的单独应用。

![销售限定词主屏幕](../../user/agents/assets/home-screen.png){width="800" zoomable="yes"}
...
![显示潜在客户管理的潜在客户状态和最后一个活动的潜在客户表](../../user/agents/assets/prospects.png){width="800" zoomable="yes"}
...
![出站工作流概述选项卡](../../user/agents/assets/outbound-workflow-overview.png){width="800" zoomable="yes"}
...
1. 选择&#x200B;**[!UICONTROL 从头开始]**&#x200B;以编写您自己的目标，或选择&#x200B;**[!UICONTROL 从模板开始]**&#x200B;以使用已保存的模板。
   ...
   ![从头开始创建出站工作流](../../user/agents/assets/outbound-workflow-create-start-from-scratch.png){width="700" zoomable="yes"}
...
1. 单击向下箭头以显示&#x200B;**[!UICONTROL 添加筛选器]**&#x200B;列表并选择要应用的筛选器。
   ...
   ![创建出站工作流定位过滤器](../../user/agents/assets/outbound-workflow-create-targeting-filter-list.png){width="700" zoomable="yes"}

1. 设置筛选器的值。

1. 如果需要缩小受众，请添加更多过滤器。

   ![创建出站工作流定位已添加具有值的筛选器](../../user/agents/assets/outbound-workflow-create-targeting-filters-values.png){width="600" zoomable="yes"}
...
![出站工作流生成的接触点节奏和提示](../../user/agents/assets/outbound-workflow-create-touchpoints.png){width="700" zoomable="yes"}
...
![出站工作流设置](../../user/agents/assets/outbound-workflow-create-settings.png){width="700" zoomable="yes"}
...
![出站工作流添加潜在客户](../../user/agents/assets/outbound-workflow-create-add-prospects.png){width="700" zoomable="yes"}
...
![出站工作流审核生成的电子邮件](../../user/agents/assets/outbound-workflow-create-review-generated-emails.png){width="700" zoomable="yes"}
...
![出站工作流生成的电子邮件人工智能推理](../../user/agents/assets/outbound-workflow-create-review-generated-email-reasoning.png){width="600" zoomable="yes"}
...
1. 在电子邮件编辑器中，单击&#x200B;**[!UICONTROL 使用AI生成]**。
   ...
   ![出站工作流使用AI生成的电子邮件细化](../../user/agents/assets/outbound-workflow-create-review-generated-email-edit-regenerate.png){width="600" zoomable="yes"}
...
![出站工作流选择和审批潜在客户](../../user/agents/assets/outbound-workflow-create-approve-enroll-prospects.png){width="700" zoomable="yes"}
...
![显示任务队列和详细信息面板的任务页面](../../user/agents/assets/tasks.png){width="800" zoomable="yes"}
...
1. 在左侧导航中，展开&#x200B;**[!UICONTROL 管理]**&#x200B;并选择&#x200B;**[!UICONTROL 集成]**。
   ...
   ![与Salesforce和Dynamics连接卡片的集成页面](../../user/agents/assets/integrations-crm-connections.png){width="800" zoomable="yes"}
...
![集成 — 知识中心](../../user/agents/assets/integrations-knowledge-center.png){width="700" zoomable="yes"}
...
![电子邮件设置选项卡，显示电子邮件连接选项和电子邮件签名配置](../../user/agents/assets/email-settings.png)
