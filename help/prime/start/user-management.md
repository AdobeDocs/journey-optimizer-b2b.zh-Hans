...
1. [在Admin Console中创建Adobe Journey Optimizer B2B edition产品配置文件](#ajo-b2b-profile)（仅限一次性/初始设置）。
...
## 创建Adobe Journey Optimizer B2B edition产品配置文件 {#ajo-b2b-profile}
...
![管理员角色要求](../../assets/do-not-localize/icon-admin-user.svg){width="30"}系统管理员或Adobe Journey Optimizer B2B edition产品管理员可以执行以下步骤。
