...
![人员列表的派生角色筛选](./assets/derived-persona-filter-people-list.png){width="700" zoomable="yes"}
...
针对拆分路径条件![派生角色筛选](./assets/derived-persona-filter-split-path.png){width="700" zoomable="yes"}
