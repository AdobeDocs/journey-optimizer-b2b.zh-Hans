...
Journey Optimizer B2B Prime通过根据定义的角色评估记录的属性，为每个人员记录派生角色。 在为人员列表或人员历程定义受众时，您可以使用推断的结果（_派生角色_）作为过滤器。

_[!UICONTROL 派生角色]_&#x200B;筛选器显示在&#x200B;**[!UICONTROL 人员属性]**&#x200B;类别下的筛选器面板中。

![访问配置的角色](../../user/admin/assets/configuration-persona-mapping.png){width="800" zoomable="yes"}
