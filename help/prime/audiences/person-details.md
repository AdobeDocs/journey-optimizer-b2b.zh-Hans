---
title: 人员详细信息
description: 查看人员的AI生成的角色、参与和意图摘要、活动历史记录、配置文件属性和公司详细信息，并向AI Assistant询问有关Journey Optimizer B2B Prime中的记录的问题。
...
在[!DNL Adobe Journey Optimizer B2B Prime]中，当您在[人员列表](./people-lists.md)的&#x200B;_[!UICONTROL 成员]_&#x200B;选项卡上单击某个人员的姓名时，将打开该人员的详细信息页面，其中包含该人员的综合视图。 本页提供：

* AI生成的角色、参与和意图摘要
* 完整的活动历史记录
* 用户档案和公司属性
* AI Assistant聊天界面具有回答有关人员问题的范围
...
## 向AI助手询问人员相关信息 {#ask-ai-assistant}

打开页面顶部附近的&#x200B;**[!UICONTROL AI助手]**&#x200B;面板图标以获取有关当前人员记录的帮助。 该面板将打开指向该人员的范围 — 消息线程下面的芯片（例如，_人员： [人员名称]_）确认您的提示目标记录是什么。

![个人详细信息 — AI助手](./assets/people-list-person-details-ai-assistant.png){width="700" zoomable="yes"}

### 从建议的提示开始 {#suggested-prompts}

当您从人员详细信息页面打开面板时，AI助手会向您发送上下文欢迎消息和默认建议提示，例如：
...
选择提示将运行多步骤[技能](../agents/skills.md)，显示为顺序状态步骤（例如，_按ID查找人员_&#x200B;和&#x200B;_获取人员故事_），而AI助手将编写答案。 响应是结构化的摘要，其中可能包括人员的配置文件详细信息、参与历史记录和电子邮件效果。

使用thumbs-up/thumbs-down控件对响应进行评级。 与所有AI Assistant输出一样，在使用响应之前对其进行审阅。 有关详细信息，请参阅[Adobe Generative AI用户准则](https://www.adobe.com/cn/legal/licenses-terms/adobe-dx-gen-ai-user-guidelines.html){target="_blank"}。
