...
* **WhatsApp** — 将图像添加到您的Meta商业帐户的WhatsApp消息模板中。 您可以直接从系统中添加它，或从&#x200B;_Assets_&#x200B;库下载图像文件。 使用此模板进行&#x200B;_发送WhatsApp_&#x200B;历程操作。 在传递WhatsApp消息时，收件人可以从消息中下载图像，并且Content Credentials是完整的。
