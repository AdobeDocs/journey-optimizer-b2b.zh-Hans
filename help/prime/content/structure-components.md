---
title: 结构组件
description: 将结构组件用于电子邮件、登陆页面和片段布局。 在Journey Optimizer B2B Prime中拖动列、设置样式并配置移动设备显示。
...
使用可视化设计空间中的&#x200B;_结构组件_&#x200B;定义内容的结构。 通过简单的拖放操作添加和移动结构元素，您可以快速定义内容布局的形状。 每个结构组件跨越水平空间，您可以栈叠它们以垂直构建布局。 将每个组件划分为列以形成所需的每个内容块，然后在其中添加[内容组件](./content-components.md)以填充布局。
...
![结构组件工具栏](../../user/assets/do-not-localize/toolbar-structure.png){width="150"}

| 工具 | 名称 | 使用情况 |
| ---- | ---- | ----- |
| ![启用条件内容](../../user/assets/do-not-localize/toolbar-button-enable-conditional-content.png){width="40"} | 启用条件内容 | （电子邮件和片段）为组件启用条件变体。 |
| ![选择列](../../user/assets/do-not-localize/toolbar-button-column-select.png){width="100"} | 选择列 | 按编号选择列。 选择列后，可以应用列设置和样式。 |
...
![显示结构组件的选项](../../user/content/assets/content-components-display-options.png){width="400" zoomable="yes"}
...
![结构组件设置为标头](../../user/content/assets/structure-component-settings-header.png){width="600" zoomable="yes"}
...
![不栈叠移动设备上的列](../../user/content/assets/structure-component-settings-stack-columns.png){width="250"}
...
![使用资源选择器的结构组件背景图像设置](../../user/content/assets/structure-components-background-image-settings.png){width="250"}
...
![结构组件上的背景图像放置预览](../../user/content/assets/structure-component-styles-background-image.png){width="250"}
...
![列工具栏](../../user/assets/do-not-localize/toolbar-column.png){width="500"}

| 工具 | 名称 | 使用情况 |
| ---- | ---- | ----- |
| — | 清除列 | 清除列中的内容。 请参阅列工具栏图中的第一个工具。 |
| ![启用条件内容](../../user/assets/do-not-localize/toolbar-button-enable-conditional-content.png){width="40"} | 启用条件内容 | （电子邮件和片段）为列启用条件变体。 |
| ![选择列](../../user/assets/do-not-localize/toolbar-button-column-select.png){width="100"} | 选择列 | 按编号选择列。 选择列后，可以应用设置和样式。 |
...
![列数设置](../../user/content/assets/structure-components-n-n-columns-number.png){width="650" zoomable="yes"}

在画布中，移动列大小调整图标以调整所选列的宽度。 当增加或减少宽度时，相邻列也会进行调整，以便所有列都占组件宽度的100%。

![调整列大小](../../user/content/assets/structure-components-n-n-columns-resize.png){width="500" zoomable="yes"}
...
* **[!UICONTROL 背景图像]** — 移动切换选择器以启用背景图像设置。
  ...
  ![样式面板中的列背景图像设置](../../user/content/assets/structure-components-background-image-settings.png){width="250"}
...
在可视设计空间中，可以使用导航树访问结构组件，包括列和内容。 单击左侧的&#x200B;_[!UICONTROL 导航树]_&#x200B;图标（![导航树图标](../../user/assets/do-not-localize/icon-navigation-tree.svg)）以显示该树。
