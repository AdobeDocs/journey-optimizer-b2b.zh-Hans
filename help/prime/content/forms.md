...
![表单状态生命周期](../../user/content/assets/status-lifecycle-diagram.png){zoomable="yes"}
...
![筛选显示的表单](../../user/content/assets/forms-list-filtered.png){width="700" zoomable="yes"}
...
在Forms列表中显示![列](../../user/content/assets/forms-customize-table-dialog.png){width="300"}
...
>additional-url="https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/prime/admin/channels/configuration-presets-forms#create-preset" text="创建表单预设"
...
1. 在&#x200B;_[!UICONTROL 创建表单]_&#x200B;对话框中，输入有用的&#x200B;**[!UICONTROL 名称]**（必需）和&#x200B;**[!UICONTROL 描述]**（可选）。
   ...
   * 保留字符为&#x200B;**_不允许_**： `\ / : * ? " < > |`
   ...
   ![创建表单对话框](../../user/content/assets/forms-create-dialog.png){width="400"}
...
1. 单击&#x200B;**[!UICONTROL 创建]**。
   ...
   ![默认表单内容](../../user/content/assets/form-new-default-content.png){width="700" zoomable="yes"}
...
![发布表单对话框](../../user/content/assets/form-publish-dialog.png){width="400"}
...
![查看已发布表单的详细信息](../../user/content/assets/form-details-published.png){width="600" zoomable="yes"}
...
![由表单](../../user/content/assets/form-used-by-published.png){width="600" zoomable="yes"}的引用使用
...
![删除表单对话框](../../user/content/assets/form-delete-dialog.png){width="400"}

如果该表单当前正在使用中，则该操作会打开一个信息对话框，警告您无法删除该表单。 单击&#x200B;**[!UICONTROL 确定]**，这将中止删除操作。

![删除表单对话框 — 无法删除正在使用的表单](../../user/content/assets/form-delete-dialog-in-use.png){width="400"}
...
![复制表单](../../user/content/assets/form-list-page-duplicate.png){width="450"}

在对话框中，输入有用的名称（唯一）和描述。 单击&#x200B;**[!UICONTROL 复制]**&#x200B;以完成操作。

![重复表单的名称和描述](../../user/content/assets/form-duplicate-dialog.png){width="400"}
...
1. 修改任何详细信息，如名称和描述。
   ...
   具有草稿状态的表单的![详细信息](../../user/content/assets/form-details-draft.png){width="600" zoomable="yes"}
...
1. 在对话框中单击&#x200B;**[!UICONTROL 创建草稿版本]**&#x200B;以在可视设计空间中打开草稿版本。
   ...
   ![创建草稿版本对话框](../../user/content/assets/form-published-edit-create-draft-dialog.png){width="400"}
...
1. 选择&#x200B;**[!UICONTROL 草稿]**&#x200B;选项卡。
   ...
   ![编辑表单草稿版本](../../user/content/assets/form-published-with-draft-edit.png){width="700" zoomable="yes"}
...
![将操作应用于所选表单](../../user/content/assets/form-actions-page-authoring.png){width="600" zoomable="yes"}
