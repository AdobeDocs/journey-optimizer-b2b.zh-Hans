---
title: C2PA元数据
description: 了解Adobe Journey Optimizer B2B Prime如何自动将C2PA元数据应用于通过创作AI生成的图像，以及这对于您的内容意味着什么。
...
当您使用创作AI为[!DNL Journey Optimizer B2B Prime]中的电子邮件内容创建图像时，C2PA元数据会自动附加到生成的图像，您无需执行任何操作。 创作AI工具为具有现有元数据（包括原始源）的图像变体生成一个组合的C2PA元数据元素。

>[!NOTE]
>
>[!DNL Journey Optimizer B2B Prime]当前不支持手动图像编辑操作。 这些操作的C2PA元数据工作流目前不适用。
