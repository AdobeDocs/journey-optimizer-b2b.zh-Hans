---
title: 内容组件
description: 在Journey Optimizer B2B Prime中设计包含内容组件的电子邮件、登陆页面和片段 — 添加按钮、文本、图像、表单和容器。
...
设计电子邮件、登陆页、模板和可视化片段的内容时，请使用[!UICONTROL 内容组件]添加可视化设计元素。 您可以在一个或多个[结构组件](./structure-components.md)中添加所需数量的内容组件，这些组件定义布局。
...
![内容组件工具栏](../../user/assets/do-not-localize/toolbar-content.png){width="450"}
...
<table>
    ...
    <tr>
        <td><img width="120px" src="../../user/assets/do-not-localize/toolbar-button-text-styles.png" alt="更改文本样式工具"></td>
...
<table>
    ...
    <tr>
        <td><img width="120px" src="../../user/assets/do-not-localize/toolbar-button-horizontal-alignment.png" alt="水平对齐工具"></td>
...
<table>
    ...
    <tr>
        <td><img width="120px" src="../../user/assets/do-not-localize/toolbar-button-create-list.png" alt="创建列表工具"></td>
...
<table>
    ...
    <tr>
        <td><img width="60px" src="../../user/assets/do-not-localize/toolbar-button-set-heading.png" alt="设置标题工具"></td>
...
<table>
    ...
    <tr>
        <td><img width="60px" src="../../user/assets/do-not-localize/toolbar-button-font-size.png" alt="字体大小工具"></td>
...
<table>
    ...
    <tr>
        <td><img width="200px" src="../../user/assets/do-not-localize/toolbar-button-font-color.png" alt="字体颜色工具"></td>
...
<table>
    ...
    <tr>
        <td><img width="200px" src="../../user/assets/do-not-localize/toolbar-button-insert-link.png" alt="插入链接工具"></td>
...
<table>
    ...
    <tr>
        <td><img width="80px" src="../../user/assets/do-not-localize/toolbar-button-remove-link.png" alt="删除链接工具"></td>
...
| 工具 | 名称 | 使用情况 |
| ---- | ---- | ----- |
| ![添加个性化内容](../../user/assets/do-not-localize/toolbar-button-add-personalization.png){width="40"} | 添加个性化 | 使用个性化编辑器在组件内容中插入个性化令牌。 [了解详情](./email-authoring.md#personalize-content) |
| ![显示源代码](../../user/assets/do-not-localize/toolbar-button-show-source-code.png){width="40"} | 显示源代码 | 在只读弹出窗口中显示组件的HTML源代码。 <br/>![显示HTML代码](../../user/content/assets/content-components-show-source-code.png){width="200"} |
| ![启用条件内容](../../user/assets/do-not-localize/toolbar-button-enable-conditional-content.png){width="40"} | 启用条件内容 | （电子邮件和片段）为组件启用条件变体。 |
| ![重复](../../user/assets/do-not-localize/toolbar-button-duplicate.png){width="40"} | 重复 | 创建组件的副本并直接将其添加到下方。 |
| ![删除](../../user/assets/do-not-localize/toolbar-button-delete.png){width="40"} | 删除 | 删除组件。 |
...
1. 使用右侧的&#x200B;**[!UICONTROL 设置]**&#x200B;和&#x200B;**[!UICONTROL 样式]**&#x200B;选项卡或画布中显示的上下文工具栏调整组件显示。
   ...
   ![定义内容组件的设置和样式](../../user/content/assets/content-components-settings-styles.png){width="600" zoomable="yes"}
...
![内容组件的显示选项](../../user/content/assets/content-components-display-options.png){width="400" zoomable="yes"}
...
![容器内容组件样式](../../user/content/assets/content-components-container.png){width="600" zoomable="yes"}
...
与工具栏一起显示的![按钮组件](../../user/content/assets/content-components-button.png){width="500" zoomable="yes"}
...
1. 为链接设置&#x200B;**[!UICONTROL 类型]**：
   ...
   * **[!UICONTROL 外部链接]** — 选择此类型以使用标准URL作为链接目标。
     ...
     在&#x200B;**[!UICONTROL Url]**&#x200B;中，输入链接目标的URL。 单击&#x200B;_个性化_ （![个性化图标](../../user/assets/do-not-localize/icon-personalize.svg) ）图标，将个性化令牌用作URL中的参数。

     ![为按钮组件定义外部链接](../../user/content/assets/component-button-link-options-external.png){width="200"}

   * **登陆页面** — 选择此类型可在<!-- Journey Optimizer B2B Edition (_Beta_) or -->连接的Marketo Engage实例中选择已发布的登陆页面。

     对于&#x200B;**[!UICONTROL 登陆页面]**&#x200B;选项，选择已发布的登陆页面。 单击&#x200B;_选择页面_&#x200B;图标（![显示链接图标](../../user/assets/do-not-localize/icon-landing-page-select.svg)）和[选择已发布的登陆页面](./landing-pages.md#link-to-landing-page)。

     ![为按钮组件定义指向登陆页面的链接](../../user/content/assets/component-button-link-options-landing-page.png){width="200"}
...
1. 在画布上选择组件，然后单击工具栏中的&#x200B;_显示源代码_&#x200B;图标。
   ...
   ![打开代码编辑器以添加HTML](../../user/content/assets/content-components-html-show-code.png){width="450"}

1. 将HTML粘贴到文本框中，然后单击&#x200B;**[!UICONTROL 保存]**。

   ![编辑HTML对话框](../../user/content/assets/content-components-html-edit-dialog.png){width="600" zoomable="yes"}
...
![与工具栏一起显示的图像组件](../../user/content/assets/content-components-image.png){width="400" zoomable="yes"}

#### 添加图像资源 {#add-image-asset}

选择要添加图像资源的方法：

* **[!UICONTROL 选择资源]** — 选择此类型以浏览并从[!DNL Journey Optimizer B2B Prime] Assets库中选择图像资源。
...
* **[!UICONTROL 导入媒体]** — 选择此类型可从系统中选择文件并将其导入[!DNL Journey Optimizer B2B Prime]资源库。
  ...
  ![将图像文件导入资源库](../../user/content/assets/email-designer-image-upload.png){width="450"}
...
1. 为链接设置&#x200B;**[!UICONTROL 类型]**：
   ...
   * **[!UICONTROL 外部链接]** — 选择此类型以使用标准URL作为链接目标。
     ...
     ![为图像组件定义外部链接](../../user/content/assets/component-button-link-options-external.png){width="250"}

   * **登陆页面** — 选择此类型可在<!-- Journey Optimizer B2B Edition (_Beta_) or -->连接的Marketo Engage实例中选择已发布的登陆页面。

     对于&#x200B;**[!UICONTROL 登陆页面]**&#x200B;选项，选择已发布的登陆页面。 单击&#x200B;_选择页面_&#x200B;图标（![显示链接图标](../../user/assets/do-not-localize/icon-landing-page-select.svg)）和[选择已发布的登陆页面](./landing-pages.md#link-to-landing-page)。

     ![为图像组件定义指向登陆页面的链接](../../user/content/assets/component-button-link-options-landing-page.png){width="250"}
...
1. 如果要覆盖表单的默认&#x200B;**[!UICONTROL 跟进类型]**，请根据页面或模板的要求更改设置。
   ...
   * **[!UICONTROL 登陆页面]** — 选择此选项可选择任意[!DNL Journey Optimizer B2B Prime]或Marketo Engage登陆页面作为跟进。
