...
1. 在对话框中，为WhatsApp消息输入唯一的&#x200B;**[!UICONTROL Name]**（必需）和&#x200B;**[!UICONTROL Description]**（可选）。
   ...
   ![创建新的WhatsApp消息对话框](../../user/content/assets/whatsapp-create-dialog.png){width="400"}
...
1. 对于&#x200B;**[!UICONTROL WhatsApp配置]**，请选择支持营销操作和消息投放设置的配置，以满足您的需求。
   ...
   ![创建WhatsApp — 操作选项卡](../../user/content/assets/whatsapp-create-actions-tab.png){width="700" zoomable="yes"}
...
1. 对于&#x200B;**[!UICONTROL 选择WhatsApp模板]**，为已配置的业务帐户选择批准的模板。
   ...
   ![在预览窗口中加载了消息的WhatsApp选定消息模板](../../user/content/assets/whatsapp-create-select-template.png){width="700" zoomable="yes"}
...
对于模板中显示的每个变量字段，单击该字段旁边的&#x200B;_个性化_&#x200B;图标（![个性化图标](../../user/assets/do-not-localize/icon-personalize.svg)）。

WhatsApp模板中的![变量](../../user/content/assets/whatsapp-create-variables.png){width="700" zoomable="yes"}
