...
有关如何将所选字段用于高级电子邮件个性化的信息，请参阅[内容个性化](../content/personalization.md#custom-datasets)。 有关如何将所选字段用于历程决策（按帐户或人员拆分路径）的信息，请参阅[自定义数据筛选](../journeys/split-merge-paths-nodes.md#custom-data-filtering)。
