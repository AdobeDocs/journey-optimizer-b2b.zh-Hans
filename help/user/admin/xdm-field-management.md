...
关系架构允许您创建自定义数据类。 通过访问多个数据集，您可以创建专门针对您的数据需求定制的类。 在历程决策和电子邮件个性化中使用[关系架构](https://experienceleague.adobe.com/en/docs/experience-platform/xdm/schema/relational#)进行业务实体，如购买、许可和事件注册。 您最多可以选择20个架构，每个架构最多可以选择50个字段。
