...
1. 配置您的SMS API凭据：
   ...
   ![配置Sinch SMS API凭据](./assets/config-sms-api-sinch.png){width="600" zoomable="yes"}
...
1. 配置您的SMS API凭据：
   ...
   ![配置Twilio SMS API凭据](./assets/config-sms-api-twilio.png){width="600" zoomable="yes"}
...
1. 配置您的SMS API凭据：
   ...
   ![配置Infobip SMS API凭据](./assets/config-sms-api-infobip.png){width="600" zoomable="yes"}
