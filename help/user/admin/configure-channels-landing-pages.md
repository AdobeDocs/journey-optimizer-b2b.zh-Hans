---
title: 登陆页面配置
description: 配置登陆页面子域和预设，以便营销人员能够在Journey Optimizer B2B edition中发布登陆页面。
...
![渠道配置 — 登陆页子域](./assets/config-channels-landing-pages-subdomains.png){width="800" zoomable="yes"}
...
1. 指定要委派的子域。
   ...
   ![登陆页面子域设置](./assets/config-channels-landing-pages-subdomain-setup.png){width="500" zoomable="yes"}
...
1. 确保将DNS记录生成到域托管解决方案中。
   ...
   ![使用DNS记录设置的登陆页子域](./assets/config-channels-landing-pages-subdomain-setup-dns.png){width="500" zoomable="yes"}
...
当营销人员[创建登陆页面](../content/landing-pages-create-publish.md#create-landing-page)时，他们必须选择登陆页面预设，才能构建登陆页面并通过[!DNL Journey Optimizer B2B Edition]利用它。 预设包括用于登陆页面的子域。
...
![渠道配置 — 登陆页面预设](./assets/config-channels-landing-pages-presets.png){width="800" zoomable="yes"}
...
1. 选择登陆页面子域。
   ...
   ![具有名称、说明和子域的登陆页面预设](./assets/config-channels-landing-pages-preset-create.png){width="500" zoomable="yes"}
...
1. 您可以通过选中&#x200B;**[!UICONTROL 与登陆页面子域]**&#x200B;相同选项，为&#x200B;**[!UICONTROL 跟踪URL]**&#x200B;选择登陆页面子域。<!-- [Learn more about tracking](../email/message-tracking.md) -->

   ![包含子域设置的登陆页面预设](./assets/config-channels-landing-pages-preset-subdomain-settings.png){width="500" zoomable="yes"}
...
1. 单击&#x200B;**[!UICONTROL 提交]**&#x200B;以确认创建登陆页面预设。
   ...
   创建登陆页面预设后，该预设将显示在状态为&#x200B;_[!UICONTROL 活动]_&#x200B;的列表中，并准备好用于[创建登陆页面](../content/landing-pages-create-publish.md#create-landing-page)。
