...
您可以通过两种方式提交单个请求以从[!DNL Adobe Journey Optimizer B2B Edition]访问和删除使用者数据：
...
[!DNL Journey Optimizer B2B Edition]隐私工具通过[!DNL Privacy Service]帮助您遵守法规。 如果您保留的是相关区域中居住人员的数据，则每个法规都适用。
...
[!DNL Journey Optimizer B2B Edition]支持两种隐私请求类型：
...
![权限图标](../assets/do-not-localize/icon_permissions-outline.svg)这些步骤要求在Experience Platform中分配的用户角色具有[!DNL Privacy Service]产品配置文件和以下[权限](./user-management.md)：
...
要在[!DNL Journey Optimizer B2B Edition]中查看隐私请求作业，请展开&#x200B;**[!UICONTROL 隐私]**&#x200B;并选择&#x200B;**[!UICONTROL 请求]**。
...
1. 对于&#x200B;**[!UICONTROL 作业类型]**，选择请求类型：
   ...
   * **[!UICONTROL 访问]**
     ...
     当您提交包含[!DNL Journey Optimizer B2B Edition]的&#x200B;**_访问_**&#x200B;请求时，[!DNL Privacy Service]返回：

     * 与潜在客户关联的[!DNL Marketo Engage]活动。
     * 与人员或帐户关联的[!DNL Journey Optimizer B2B Edition]活动。

   * **[!UICONTROL 删除]**

     当您提交[!DNL Marketo Engage]和[!DNL Journey Optimizer B2B Edition]的&#x200B;**删除**&#x200B;请求时，将删除以下记录：

     * [!DNL Marketo Engage]中的关联潜在客户。
     * 在[!DNL Journey Optimizer B2B Edition]中创建的人员和帐户记录。
     * 引用个人信息的AI助手对话历史记录。
...
| `include` | `marketo`以包括[!DNL Journey Optimizer B2B Edition]和[!DNL Marketo Engage]数据 |
...
以下示例提交了一个包含[!DNL Journey Optimizer B2B Edition]数据的GDPR删除请求。
