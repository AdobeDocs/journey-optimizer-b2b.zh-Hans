...
* _[!UICONTROL B2B渠道配置]_ > _[!UICONTROL 发布Forms预设]_ — 发布表单预设配置所需。
...
1. 在导航面板中的&#x200B;_[!UICONTROL 表单设置]_&#x200B;下，选择&#x200B;**[!UICONTROL 表单预设]**。
   ...
   ![访问表单配置](./assets/config-channels-forms.png){width="800" zoomable="yes"}
...
1. 单击&#x200B;_选择数据集_ （ ![选择数据集图标](../assets/do-not-localize/icon-select-data.svg) ）图标可将数据集与表单关联。
   ...
   ![选择数据集对话框](./assets/config-channel-forms-select-datasets.png){width="500" zoomable="yes"}
