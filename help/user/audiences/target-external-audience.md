...
激活后，您可以在[Adobe Target受众](https://experienceleague.adobe.com/en/docs/target/using/audiences/create-audiences/audiences#use-list){target="_blank"}中看到该受众，并在Adobe Target活动中使用该受众。
