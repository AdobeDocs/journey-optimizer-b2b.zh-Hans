...
Adobe Journey Optimizer B2B edition基于Adobe Experience Platform构建。 对于此实施，Journey Optimizer B2B edition和Marketo Engage不在同一系统和同一数据存储中。 Journey Optimizer B2B edition从Adobe Experience Platform接收数据。 但是，它继续依赖Marketo Engage权利和一些后端功能（如电子邮件投放）来配置和配置系统。
...
此实施是解锁Journey Optimizer B2B edition中各项功能的基础：

* **轻松统一和扩展您的数据：**&#x200B;该平台支持复杂的数据模型，包括自定义对象、购买群组和帐户事件。

* **连接多个Adobe Marketo Engage实例：**&#x200B;在一个位置管理和统一多个Marketo Engage环境中的数据。

* **保护您的数据安全：**&#x200B;高级隐私和安全功能有助于保护您的客户信息。 （_即将推出_）

* **为未来构建：**&#x200B;此设置支持正在进行的改进和创新。
...
<tbody>
<tr>
<td colspan="2"><strong>标准XDM配置</strong>：设置XDM个人配置文件和XDM商业帐户架构。</td>
<td></td>
</tr>
<tr>
<td><img src="../assets/do-not-localize/icon-checkbox.svg" width="25" alt="复选框"/></td>
...
<tr>
<td colspan="2"><strong>关系架构</strong>：选择关系XDM字段（帐户多对一自定义对象）。</td>
<td></td>
</tr>
<tr>
<td><img src="../assets/do-not-localize/icon-checkbox.svg" width="25" alt="复选框"/></td>
...
要从[!DNL Journey Optimizer B2B Edition]发送电子邮件，请在附加的[!DNL Marketo Engage]生产实例和[!DNL Journey Optimizer B2B Edition]应用程序中配置电子邮件跟踪和可投放性。
