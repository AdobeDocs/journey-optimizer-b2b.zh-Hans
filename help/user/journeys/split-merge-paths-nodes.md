...
* _按人员拆分路径_&#x200B;节点是分组节点。 路径会自动合并，以便受众中的所有人员能够前进到下一步骤，而不会丢失其帐户上下文。
* _无法嵌套按人员拆分路径_&#x200B;节点 — 无法为位于此分组节点中的路径上的人员添加拆分路径。
* 拆分路径节点包括一个用于省略默认路径的选项，以便没有匹配路径的帐户/人员不会在历程中前进。
* _按人员拆分路径_&#x200B;节点支持使用&#x200B;_帐户 — 人员关系_，这允许您根据角色模板中定义的角色（如承包商或全职员工）筛选人员。
