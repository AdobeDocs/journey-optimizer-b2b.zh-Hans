...
例如，您可以根据不同角色中的深度（人员数）来评估购买群体准备情况，例如三个决策者和两个影响者。 在这种情况下，将条件设置为在匹配购买组中至少有三(3)名决策者和两(2)名影响者的目标客户：
...
对于已识别的帐户，您可以在路径中添加操作节点，以更新购买组或阶段的状态，或者发送销售警报电子邮件。
...
>**功能弃用**</br></br>
>
>在当前Journey Optimizer B2B edition版本中，不支持基于Marketo Engage实例中的列表或项目成员资格进行筛选。
