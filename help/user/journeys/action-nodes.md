...
| 上下文 | 历程类型 | 操作 | 约束 |
| ------- | ------------ | ------ | ----------- |
| [Journey Optimizer B2B](#journey-optimizer-b2b-actions) | <li>帐户历程 <li>人员历程 | [!UICONTROL 添加到外部客户受众] | <li>选择外部客户受众 |
| | <li>帐户历程 | [!UICONTROL 分配给购买组] | <li>选择解决方案兴趣 <li>选择角色 |
| | <li>帐户历程 | [!UICONTROL 更改得分] | 得分名称 <li>分数更改 |
| | <li>帐户历程 <li>人员历程 | [!UICONTROL 个人有趣的时刻] | <li>类型 <li>描述 |
| | <li>帐户历程 | [!UICONTROL 个性化Web体验] (Beta) | <li>创建/编辑Web体验 |
| | <li>帐户历程 | [!UICONTROL 从购买群中删除] | <li>选择解决方案兴趣 |
| | <li>帐户历程 <li>人员历程 | [!UICONTROL 发送电子邮件] | <li>创建电子邮件 |
| | <li>帐户历程 | [!UICONTROL 发送短信] | <li>创建短信 |
| | <li>帐户历程 <li>人员历程 | [!UICONTROL 更新人员配置文件] | <li>选择人员属性 <li>设置新值 |
| [Marketo Engage](#marketo-engage-actions) | <li>帐户历程 <li>人员历程 | [!UICONTROL 添加到Marketo Engage请求营销活动] | <li>选择 Marketo Engage 工作区 <li>选择请求营销活动 |
| | [!UICONTROL 添加到Marketo列表] | <li>帐户历程 <li>人员历程 | <li>外部Marketo连接的名称 <li>列表名称 |
| | [!UICONTROL 从Marketo列表中删除] | 帐户历程 <li>人员历程 | <li>外部Marketo连接的名称 <li>列表名称 |
...
* 在创建受众并将其用于此历程操作时，请确保连接目标。 有关详细信息，请参阅[文档中的](https://experienceleague.adobe.com/zh-hans/docs/experience-platform/destinations/ui/connect-destination){target="_blank"}创建新的目标连接[和](https://experienceleague.adobe.com/zh-hans/docs/experience-platform/destinations/ui/activate/activation-overview#activate-audiences-from-the-destinations-catalog){target="_blank"}激活概述[!DNL Experience Platform]。
...
>[!NOTE]
>
>_[!UICONTROL 更新人员配置文件]_&#x200B;替换了&#x200B;_[!UICONTROL 简化架构]_.[中的](../simplified-architecture.md)更改数据值<br/>操作
>
