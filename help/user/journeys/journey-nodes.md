...
| 节点上下文 | 活动 | 约束 |
| ------------ | ----- | ----------- |
| [人员](#add-a-people-event) | 已分配给购买组 | 解决方案兴趣<br/>其他约束（可选）： <ul><li>角色</li><li>活动日期</li></ul><br/>超时（可选） |
| | 单击电子邮件中的链接 | 电子邮件<br/>其他约束（可选）： <ul><li>链接</li><li>链接Id</li><li>是移动设备</li><li>设备</li><li>平台</li><li>浏览器</li><li>是预测内容</li><li>是机器人活动</li><li>机器人活动模式</li><li>浏览器</li><li>活动日期</li><li>最低 次数</li></ul><br/>超时（可选） |
| | 短信中的点击链接 | 电子邮件<br/>其他约束（可选）：<ul><li>链接</li><li>设备</li><li>平台</li><li>活动日期</li><li>最低 次数</li></ul><br/>超时（可选） |
| | 数据值更改 | 人员属性<br/>其他约束（可选）：<ul><li>新值</li><li>上一个值</li><li>原因</li><li>来源</li><li>活动日期</li><li>最低 次数</li></ul><br/>超时（可选） |
| | 打开电子邮件 | 电子邮件<br/>其他约束（可选）： <ul><li>链接</li><li>链接Id</li><li>是移动设备</li><li>设备</li><li>平台</li><li>浏览器</li><li>是预测内容</li><li>是机器人活动</li><li>机器人活动模式</li><li>浏览器</li><li>活动日期</li><li>最低 次数</li></ul><br/>超时（可选） |
| | 已从购买组中移除 | 解决方案兴趣<br/>活动日期（可选）<br/>超时（可选） |
| | 分数已更改 | 得分名称<br/>其他约束（可选）：<ul><li>更改</li><li>新得分</li><li>紧急</li><li>优先级</li><li>相对分数</li><li>相对紧迫性</li><li>活动日期</li><li>最低 次数</li></ul><br/>超时（可选） |
| | 短信退回 | SMS消息<br/>其他约束（可选）：<ul><li>活动日期</li><li>最小次数</li></ul><br/>超时（可选） |
| [帐户](#add-an-account-event) | 账户有有趣的时刻 | 类型（电子邮件、里程碑或Web）<br/>其他约束（可选）：<ul><li>描述</li><li>来源</li><li>活动日期</li></ul> <br/>超时（可选） |
| | 帐户数据值更改 | 属性<br/>其他约束（可选）：<ul><li>新值</li><li>上一个值</li><li>活动日期</li></ul> <br/>超时（可选） |
| | 购买组状态的更改 | 解决方案兴趣<br/>其他约束（可选）：<ul><li>新状态</li><li>以前的状态</li><li>活动日期</li></ul><br/>超时（可选） |
| | 完整性分数的更改 | 解决方案兴趣<br/>其他约束（可选）：<ul><li>新得分</li><li>上一个得分</li><li>活动日期</li></ul><br/>超时（可选） |
| | 参与度分数的更改 | 解决方案兴趣<br/>其他约束（可选）：<ul><li>新得分</li><li>上一个得分</li><li>活动日期</li></ul><br/>超时（可选） |
...
| 节点上下文 | 路径条件 | 描述 |
| ------------ | --------------- | ----------- |
| [人员](#add-a-split-path-by-people-node) | [!UICONTROL 人员属性] | 人员配置文件中的属性，包括： <ul><li>城市</li><li>国家/地区</li><li>出生日期</li><li>电子邮件地址</li><li>电子邮件无效</li><li>电子邮件已暂停</li><li>名字</li><li>推断的状态区域</li><li>职务名称</li><li>姓氏</li><li>手机号码</li><li>电话号码</li><li>邮政编码</li><li>State</li><li>退订</li><li>取消订阅的原因</li></ul> |
| | [!UICONTROL 活动历史记录] > [!UICONTROL 电子邮件] | 与历程关联的电子邮件活动： <ul><li>[!UICONTROL 已单击电子邮件中的链接]</li><li>已打开的电子邮件</li><li>已送达电子邮件</li><li>已发送电子邮件</li></ul> 使用历程中早期的选定电子邮件评估这些条件。 |
| | [!UICONTROL 活动历史记录] > [!UICONTROL 数据值已更改] | 对于选定的人员属性，发生值更改。 这些更改类型包括： <ul><li>新值</li><li>上一个值</li><li>原因</li><li>来源</li><li>活动日期</li><li>最低 次数</li></ul> |
| | [!UICONTROL 活动历史记录] > [!UICONTROL 快乐时光] | 在关联的Marketo Engage实例中定义的有趣时刻活动。 限制包括： ul><li>里程碑</li><li>电子邮件</li><li>Web</li></ul> |
| | [!UICONTROL 特殊筛选器] > [!UICONTROL 购买团体成员] | 人员是否属于根据以下一个或多个标准评估的购买组成员： <ul><li>解决方案兴趣</li><li>购买组状态</li><li>完整性分数</li><li>参与度分数</li><li>角色</li></ul> |
| [帐户](#add-a-split-path-by-account-node) | 帐户属性 | 帐户个人资料中的属性，包括： <ul><li>年收入</li><li>城市</li><li>国家/地区</li><li>员工人数</li><li>行业</li><li>名称</li><li>SIC代码</li><li>State</li></ul> |
| | [!UICONTROL 特殊筛选器] > [!UICONTROL 有购买群] | 客户是否根据以下一个或多个标准评估购买组成员： <ul><li>解决方案兴趣</li><li>购买组状态</li><li>完整性分数</li><li>参与度分数</li></ul> |
