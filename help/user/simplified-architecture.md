...
<td><a href="./admin/user-management.md#create-the-marketo-engage-product-profile">了解详情</a></td>
</tr>
<tr>
<td><img src="../assets/do-not-localize/icon-checkbox.svg" width="25" alt="复选框"/></td>
<td>为配置文件添加用户组</td>
<td><a href="./admin/user-management.md#add-a-user-group-for-the-profile">了解详情</a></td>
</tr>
<tr>
<td><img src="../assets/do-not-localize/icon-checkbox.svg" width="25" alt="复选框"/></td>
<td>配置B2B用户角色</td>
