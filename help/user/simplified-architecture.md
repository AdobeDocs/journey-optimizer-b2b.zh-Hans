...
启用共享通信限制后，您可以在Journey Optimizer B2B edition中定义规则，并将这些限制的共享扩展到Marketo Munchkin代码。 有关详细信息，请参阅[通信限制](./admin/configure-channels-emails.md#communication-limits)
