---
title: Web参与仪表板
description: 通过页面查看分析、区域洞察和行业细分分析Web访客行为，为您的内容策略提供信息。
...
![Web参与仪表板](./assets/web-engagement-dashboard.png){width="700" zoomable="yes"}

## 筛选数据

单击左上角的&#x200B;_筛选器_ （![筛选器图标](../assets/do-not-localize/icon-filter.svg)）图标，以使用以下任意属性筛选显示的数据：

* **[!UICONTROL 帐户区域]** — 按与帐户关联的一个或多个选定地理区域筛选数据。
* **[!UICONTROL 帐户行业]** — 按与帐户关联的一个或多个选定行业分类筛选数据。
* **[!UICONTROL 日期范围]** — 按选定的日期范围筛选数据。 默认范围是当前日期。

![按属性筛选显示的数据](./assets/web-engagement-dashboard-filters-dialog.png){width="500"}
...
![热门页面查看次数表](./assets/web-engagement-dashboard-top-page-views.png){width="650" zoomable="yes"}
...
![按帐户区域划分的页面浏览量](./assets/web-engagement-dashboard-page-views-by-account-region.png){width="500" zoomable="yes"}
...
![按帐户行业划分的页面浏览量](./assets/web-engagement-dashboard-page-views-by-account-industry.png){width="500" zoomable="yes"}
...
![热门页面查看表查看更多弹出窗口 — 单击下载CSV](./assets/web-engagement-dashboard-top-page-views-view-more.png){width="700" zoomable="yes"}
