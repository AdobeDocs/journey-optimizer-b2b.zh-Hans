...
* 您的网站已实现[Adobe Experience Platform Web SDK](https://experienceleague.adobe.com/en/docs/experience-platform/collection/js/js-overview) (`alloy.js`)，用于访问者识别和内容传递。 需要Adobe Experience Platform Web SDK版本2.16或更高版本。
