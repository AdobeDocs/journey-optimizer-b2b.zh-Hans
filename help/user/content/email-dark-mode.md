...
>title="切换到深色模式"
>abstract="切换到深色模式以预览渲染并定义自定义设置。 <br>渲染取决于收件人的电子邮件客户端。 并非所有电子邮件客户端都支持自定义深色模式。"

>[!CONTEXTUALHELP]
>id="ajo-b2b_dark_mode_preview"
>title="切换到深色模式"
>abstract="切换到深色模式以在支持的电子邮件客户端上预览渲染。 <br>最终的渲染效果取决于收件人的电子邮件客户端。 请注意，并非所有电子邮件客户端都支持深色模式。"
...
* 如果要覆盖支持电子邮件客户端的默认设置，请定义自定义深色模式设置并将其应用于电子邮件内容。 [了解详情](#custom-dark-mode)
...
>[!CAUTION]
>
>最终渲染可能会因收件人的电子邮件客户端而异。 若要查看与每个电子邮件客户端的最终结果尽可能接近的模拟，请使用[Litmus电子邮件测试渲染](./email-test-rendering.md)集成。
...
>title="为深色模式使用特定图像"
>abstract="为深色模式选择其他图像。 <br>添加特定图像并不能保证所有电子邮件客户端中的渲染均正确。 并非所有电子邮件客户端都支持自定义深色模式。"
...
| 在深色模式环境中测试电子邮件 | 清单：<ul><li>使用电子邮件设计空间中的[深色模式预览](#preview-dark-mode)，它使用反转的颜色方案来提前发现问题。 <li>使用带有[_[!UICONTROL 呈现电子邮件]_](./email-test-rendering.md)选项的Litmus Enterprise帐户模拟您跨主要电子邮件客户端（如Apple Mail、Gmail和Outlook）的设计，并查看颜色和图像在深色模式下的行为。 |
