...
* **[!UICONTROL 购买群]** — 选择[购买群角色](../buying-groups/buying-groups-role-templates.md)，以用于定位您的消息传送。 [!DNL Journey Optimizer B2B Edition]提供五个预先配置的标准B2B购买小组角色。 每个购买团体角色都有不同的消息传递重点：
...
1. （可选）要为生成预编译标头提供其他输入，请完成内容指导设置：
