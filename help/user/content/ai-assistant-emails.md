...
![显示“内容类型”、“视觉强度”、“颜色和色调”、“光源”和“合成”选项的“图像设置”面板](./assets/gen-ai-image-settings.png){width="350" zoomable="yes"}
...
从历程创建电子邮件或从历程节点打开现有电子邮件时，电子邮件预览页面会在右侧显示&#x200B;_[!UICONTROL 电子邮件属性]_。 在&#x200B;_[!UICONTROL 摘要]_&#x200B;选项卡中，可以使用AI助理内容生成工具生成主题行和/或预标题。
