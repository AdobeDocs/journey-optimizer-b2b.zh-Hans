...
description: 使用AI Assistant加快工作流程 — 获取Journey Optimizer B2B edition的产品知识、故障排除帮助和运营见解。
...
Journey Optimizer B2B edition中的AI助手是基于Adobe Experience Platform[中的](https://experienceleague.adobe.com/zh-hans/docs/experience-platform/ai-assistant/home){target="_blank"}AI助手所基于的相同技术创建的。 它是一种对话式体验，可用于加快Adobe Journey Optimizer B2B edition中的工作流程。 您可以使用AI Assistant进一步了解产品功能、排除问题或搜索信息并查找Journey Optimizer B2B edition的操作见解。
...
不是。AI Assistant无法访问客户数据，因此，AI Assistant不会查看或使用这些数据。
