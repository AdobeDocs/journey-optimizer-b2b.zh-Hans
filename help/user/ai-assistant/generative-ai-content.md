...
>title="AI 内容生成"
>abstract="完成布局设计后，您可以在 [!DNL Journey Optimizer B2B Edition] 中使用生成式 AI 工具来增强您的内容。 此功能可根据您的描述性提示对内容进行微调，从而简化个性化和内容优化流程。"

>[!CONTEXTUALHELP]
>id="ajo_b2b_ai-generation-reference-context"
>title="参考内容"
>abstract="使用&#x200B;_参考内容_&#x200B;上传包含相关内容的资源文件，为 [!DNL Journey Optimizer B2B Edition] 中的生成式 AI 提供额外上下文，或选择之前上传的文件。 此选项可确保所有必要材料均可用于提升生成内容的质量和相关性。"

>[!CONTEXTUALHELP]
>id="ajo_b2b_ai-generation-start"
>title="Adobe 生成式 AI 条款"
>abstract="此功能的访问取决于您是否同意遵守 Adobe Experience Cloud 生成式 AI 用户指南。 请审阅此功能生成的任何输出内容，以确保其准确性并适用于您的用例。"
...
* [!BADGE Beta] [登录页面](../content/ai-assistant-landing-pages.md)

## 一般准则和限制 {#general-guidelines-and-limitations}

您对创作AI功能的使用受[Adobe Experience Cloud创作AI用户指南](https://www.adobe.com/cn/legal/licenses-terms/adobe-dx-gen-ai-user-guidelines.html){target="_blank"}的约束。 由于Adobe承诺在使用创作AI工具创建媒体时保持透明度，因此Adobe在下载或导出包含[!DNL Firefly]生成的资源的任何内容或项目时会应用[内容凭据](https://helpx.adobe.com/cn/firefly/web/get-started/learn-the-basics/content-credentials-overview.html){target="_blank"}。
...
## 生成式 AI 提示的最佳做法 {#generative-ai-prompting-guide}

>[!CONTEXTUALHELP]
>id="ajo_b2b_ai_content_prompt"
>title="提示指南"
>abstract="查阅 [!DNL Journey Optimizer B2B Edition] 文档，了解如何创建有效提示，以生成高转化率且符合品牌风格的营销内容。"
...
![绿色复选标记](../../assets/do-not-localize/check-box-green.svg){width="20"} **审阅选择**：已选择音调、策略和区域设置，请勿将其包含在提示中。

![绿色复选标记](../../assets/do-not-localize/check-box-green.svg){width="20"} **指定了文档焦点**：突出显示要引用的内容或部分。

![绿色复选标记](../../assets/do-not-localize/check-box-green.svg){width="20"} **已应用品牌**：已选择适当的品牌指南。
...
![绿色复选标记](../../assets/do-not-localize/check-box-green.svg){width="20"}“推动注册以免费试用新的AI支持分析仪表板的30天”

![绿色复选标记](../../assets/do-not-localize/check-box-green.svg){width="20"} “为将于3月15日举行的‘将云成本降低40%’的B2B网络研讨会创造商机”

![绿色复选标记](../../assets/do-not-localize/check-box-green.svg){width="20"} “促销高级订阅的限时25%折扣，截止时间为12月25日”

**要避免的示例：**

![红十字会](../../assets/do-not-localize/check-box-red.svg){width="20"} “促销产品”（太模糊）

![红十字会](../../assets/do-not-localize/check-box-red.svg){width="20"} “让他人签署协议”（价值不明确）

![红十字会](../../assets/do-not-localize/check-box-red.svg){width="20"} “关于新功能的电子邮件”（目的不足）

#### 构建目标

始终为生成相关内容提供上下文和价值主张。 使用以下公式可以帮助您编写有效的目标： **操作+产品/服务+值/好处+紧急情况/上下文**

**良好目标示例：**

![绿色复选标记](../../assets/do-not-localize/check-box-green.svg){width="20"} “鼓励下载新的移动应用程序，帮助用户通过个性化的生态友好推荐跟踪可持续生活习惯”

![绿色复选标记](../../assets/do-not-localize/check-box-green.svg){width="20"} “推广注册营销专业人员高级数据可视化技术独家研讨会”

![绿色复选标记](../../assets/do-not-localize/check-box-green.svg){width="20"} “提高产品上市活动的出席率，展示革命性的AI编写助手，每周可节省5小时以上的时间”

**要避免的示例：**

![红十字会](../../assets/do-not-localize/check-box-red.svg){width="20"} “宣布新应用程序”（缺少值主张和上下文）

![红十字会](../../assets/do-not-localize/check-box-red.svg){width="20"} “让人员注册参加研讨会”（缺少有关受众和优势的具体说明）

![红十字会](../../assets/do-not-localize/check-box-red.svg){width="20"} “促销活动”（无明确的操作、值或紧迫性）
...
**如何提示** ➤创建新内容时，请专注于您的营销目标而不引用现有内容。

>[!BEGINSHADEBOX “示例”]

* **SaaS试用版**：“向小型企业所有者发布新的CRM软件，节省时间达50%，潜在客户认证速度加快90%，并提供包含个性化入门的30天免费试用版”
* **功能发布**： “宣布新的API集成功能，将企业客户的开发时间减少60%，主要针对技术决策者”
* **活动促销活动**： “推动有关‘2024年数字营销趋势’网络研讨会的注册，注册专家来自Google、Meta和Adobe，重点提供可操作的见解和有限的名额（最多500个）”
...
>[!TIP]
>
>对于诸如精细、概括或简化之类的标准修改，请选择&#x200B;**_优化_**，而不是编写自定义提示。
...
* **Campaign更新**： “修改项目启动电子邮件，将重点放在企业安全功能上，而不是放在一般的生产力优势上，并将目标定位为具有合规性认证的IT决策者”
* **受众透视**：“调整软件演示邀请，使其专门面向医疗保健行业，将通用示例替换为医疗保健用例和HIPAA合规性好处”
* **季节性更新**： “更新第4季度假期购物的第3季度促销活动，将焦点从返校转为强调快速送货的假日礼品馈送”
...
| **Education &amp; Insights** | 学习内容、行业趋势、最佳实践 | 提供宝贵的知识和可操作的外包 | <li>“使用专家指南学习高级技术” <li>“探索顶级营销人员使用的7种策略” <li>“了解如何通过5个步骤优化您的工作流” |
...
>[!TIP]
>
>如果您已经通过&#x200B;**[!UICONTROL 引用内容]**&#x200B;菜单上传了资产，则无需在提示中引用它。 系统会自动使用任何选定的文档。

参考内容文件提供了真实的信息，通过特定、准确的详细信息丰富了您生成的内容。 上传文档（如产品小册子或白皮书）时，请更改提示以包括哪些部件具有焦点：

* **不要使用** _“使用产品手册”_ **您应该使用** _“专注于高级安全功能和合规性认证，尤其是SOC 2合规性和数据加密”_

* **而不是** _“参考案例研究”_ **您应该使用** _“重点介绍来自医疗保健客户的ROI结果，特别是地区医疗中心的40%成本降低”_

* **不应** _“包含技术详细信息”_ **您应当使用** _“强调API集成功能和开发人员权益，重点关注REST API端点和99.9%正常运行时间SLA”_

### 内容细化

生成内容后，使用&#x200B;**_[!UICONTROL 优化]_**&#x200B;功能通过以下选项对其进行迭代和增强：

* **[!UICONTROL 复杂]** - AI助手可以帮助您展开特定主题，提供其他详细信息以便更好地了解和参与。

* **[!UICONTROL 摘要]** — 过长的信息可能会使页面查看者过载。 使用AI Assistant将关键点浓缩为清晰、简洁的摘要，以吸引注意并鼓励他们进一步阅读。

* **[!UICONTROL 重新短语]** — 重新写入邮件，同时保留其含义。 此选项可帮助您在不更改核心消息的情况下生成替代措辞、改善流量或调整词语。

* **[!UICONTROL 使用更简单的语言]** — 简化语言，确保为更广泛的受众提供清晰易懂的语言。

* **[!UICONTROL 翻译]** — 将文本翻译成其他语言。 （目前，英语是唯一受支持的语言。）

* **[!UICONTROL 更改语调]** — 调整消息语调以符合您的沟通风格，例如使其更友好、更专业、更紧急或更具启发性。

* **[!UICONTROL 更改沟通策略]** — 根据您的目标修改消息传送方法，例如创建紧迫感或强调令人兴奋的吸引力。
