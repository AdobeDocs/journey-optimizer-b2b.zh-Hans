...
| 功能 | WhatsApp 渠道 | [!BADGE 简化的架构]{type=Informative tooltip="提供简化的架构"}营销人员现在可以通过[!DNL Meta Cloud API]直接从帐户历程发送WhatsApp消息。 此功能可实现WhatsApp消息传送的无缝集成，以支持历程内容渠道。 [了解详情](../admin/configure-channels-whatsapp.md) |
...
| 功能 | 历程的自定义外部操作 | [!BADGE 简化的架构]{type=Informative tooltip="提供简化的架构"}开发人员现在可以使用API构建与其第一方系统的集成。 通过这些自定义集成，营销人员可以添加&#x200B;_外部操作_&#x200B;和&#x200B;_外部拆分路径_&#x200B;节点，以在帐户历程执行期间向外部服务发出出站请求。 [了解详情](../admin/configure-external-actions.md) |
...
| 增强功能 | 人员自定义对象 — 购买群组角色模板 | [!BADGE 简化的架构]{type=Informative tooltip="提供简化的架构"}管理员配置与业务人员配置文件相关的自定义对象时，营销人员现在可以使用这些自定义对象定义购买群组角色。 [了解详情](../buying-groups/buying-groups-role-templates.md#add-the-template-roles) |
