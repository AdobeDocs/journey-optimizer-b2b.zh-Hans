...
有了更新的架构，Journey Optimizer B2B Edition和Marketo Engage将不在同一系统和同一数据存储中。 Journey Optimizer B2B Edition从Adobe Experience Platform接收数据。 但仍依赖 Marketo Engage 的使用权限及部分配置功能来完成系统的部署与设置。
