...
| 类型 | 项目 | 描述 |
| ---- | ---- | ----------- |
| 功能 | XDM字段/关系架构 — 支持人员自定义对象 | 管理员现在可以通过与帐户的单级别一对一关系选择与人员相关的自定义对象。 此功能使您的营销组织能够呈现更丰富的真实业务数据视图，从而定向、个性化和报告人员或帐户级别以外的实体。 |
...
| 增强功能 | 帐户和人员历程 — 支持人员自定义对象 | 利用链接到帐户的关系数据来过滤帐户或人员历程中的人员。 |
| 增强功能 | 内容个性化 — 支持人员自定义对象 | 在使用自定义对象定义内容个性化时，您可以访问基于模型的类自定义对象（关系架构）的变量。 |
