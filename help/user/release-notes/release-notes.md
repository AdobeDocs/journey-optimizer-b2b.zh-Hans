...
| 功能 | 体验事件历史记录筛选 | 此功能使B2B Journey Orchestration能够使用历史参与为受众成员制定基于行为的决策。 |
| 功能 | 历程分割路径决策 | 您可以针对帐户和人员历程优化拆分路径决策，从而优化在历程激活之前或运行时受众在路径间的路由方式。 |
| 增强功能 | Audience Agent技能 | 更新Audience Agent技能，包括AI支持的购买群组模板创建。 使用第一方意图和角色映射生成购买组模板，审查AI推荐的角色到角色映射，并在发布模板之前使用自然语言优化模板。 |
| 增强功能 | 电子邮件参与性能报表 | 电子邮件参与度性能报表为营销人员提供了Adobe Journey Optimizer B2B edition中所有历程的电子邮件活动的统一视图。 |
| 增强功能 | 人员历程概述仪表板 | 此仪表板提供活动人员历程的全面概述。 |
