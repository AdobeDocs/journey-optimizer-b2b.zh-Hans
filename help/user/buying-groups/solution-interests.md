...
您可以通过单击省略号(...)删除购买组作业 在作业名称旁边，然后选择&#x200B;**[!UICONTROL 删除]**。
...
1. 启用&#x200B;**[!UICONTROL 更新现有购买组]**&#x200B;设置（可选）。
   ...
   启用此选项后，与解决方案相关的所有现有购买组都将通过每日同步周期进行更新。
...
1. 在&#x200B;_[!UICONTROL Solution interest]_&#x200B;选项卡中，单击省略号(**...**) 在解决方案感兴趣的旁边，然后选择&#x200B;**[!UICONTROL 删除]**。
