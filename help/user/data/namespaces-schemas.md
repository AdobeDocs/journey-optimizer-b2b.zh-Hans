...
>[!AVAILABILITY]
>
>- 您必须有权访问[Adobe Real-Time Customer Data Platform B2B edition](https://experienceleague.adobe.com/zh-hans/docs/experience-platform/rtcdp/intro/rtcdpb2b-intro/b2b-overview){target="_blank"}，您的B2B架构才能在[实时客户档案](https://experienceleague.adobe.com/zh-hans/docs/experience-platform/profile/home){target="_blank"}中获得资格。
>
