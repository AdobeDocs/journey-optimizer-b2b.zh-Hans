...
如果您是Adobe社区的一员，并且希望创建新主题或提交重大更改，请使用适用的Git存储库中的&#x200B;**问题**&#x200B;选项卡提交问题。 新问题会开始与文档团队的对话。 在就计划达成一致后，您可以与Adobe作者合作发布修订。

**注意：**&#x200B;如果您提交了对文档和代码示例进行重大更改的拉取请求，则该拉取请求会显示一条消息，要求您提交在线贡献许可协议(CLA)。 需要填写此在线表单，团队成员才能查看您的拉取请求。
...
如果您是Adobe产品团队的技术文档撰稿人、项目经理或开发人员，并且您的工作就是撰写或创作技术文章，请使用[专用存储库](https://git.corp.adobe.com/AdobeDocs)。
